...
namespace Core.EventBus.RabbitMQ
{
    ...
    {
        const string BROKER_NAME = "thinkfree_event_bus";

        private RabbitMQPersistentConnection _persistentConnection;

        private MemoryEventBusSubscriptionsManager _subsManager;
        ...
        public RabbitMQEventBus(string queueName)
        {
            ...
            _subsManager = new MemoryEventBusSubscriptionsManager();
        ...
        private async Task ProcessEvent(string eventName, string message)
        {
            if (_subsManager.HasSubscriptionsForEvent(eventName))
            {
                ...
                foreach (var subscription in subscriptions)
                {
                    ...
                    var handler = subscription.DynamicInvoke();
